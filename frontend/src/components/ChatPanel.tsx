        ...
        {messages.length === 0 ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            {messages.map((msg, index) => {
              ...
              const hasGrammarError = nextMessage?.type === 'system';
                  ...
                  {msg.type === 'system' ? (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {msg.content}
                          {msg.type === 'user' && grammarErrors.length > 0 && (
                            <GrammarTooltip errors={grammarErrors}>
                              <span
                                style={{
                                  ...
                                  justifyContent: 'center',
                                  cursor: 'pointer',
                                  boxShadow: '0 2px 8px rgba(245, 34, 45, 0.4)',
                                }}
                              >
                                <WarningOutlined style={{ color: '#fff', fontSize: '12px' }} />
                              </span>
                            </GrammarTooltip>
                          )}
                        </div>
